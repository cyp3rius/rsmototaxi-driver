...
export default function WeeklyPayoutDetailPage() {
  ...
  return (
    <AppShell hideNav>
      <PageHeader title="Rozliczenie tygodniowe" onBack={() => router.back()} />
      <div className="px-5 pb-10">
        <p className="text-[15px] text-[var(--text-secondary)]">
          {String(data?.weekLabel || data?.periodLabel || '—')} · charakter kontrolny
        </p>
        <p
            ...
            {rows.map(([label, value], index) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-right font-medium tabular-nums ${isFinal ? 'font-semibold' : ''}`}>
